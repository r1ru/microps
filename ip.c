...
static struct ip_iface *ifaces = NULL;

// Global list of IP protocols.
...
// Converts a printable text into an ip address.
...
// Converts an ip address into a printable text.
...
// Registers the IP interface to the network device.
